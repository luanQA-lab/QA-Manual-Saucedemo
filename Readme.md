...
## Enlace a la aplicación bajo prueba
...
| Ítem                  | Detalle                                      |
|-----------------------|----------------------------------------------|
| Alcance               | Funcionalidades de login, catálogo, carrito y checkout |
| Estrategia            | Pruebas funcionales positivas y negativas, exploratorias |
| Recursos             | 1 tester manual, navegador Edge   |
| Criterios de entrada  | Aplicación disponible y estable              |
...
¡Gracias por visitar mi portafolio de QA!